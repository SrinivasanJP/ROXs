      ...
      <div className="bg-[#fefefe] w-[90%] mx-[10%] rounded-2xl shadow-2xl flex flex-wrap md:p-10 p-2">
        ...
        <div className="w-full md:w-1/2 p-5 flex flex-col justify-center">
          ...
          <form className='mt-5' action='/'>
            ...
            <input type="text" name="uname" id="uname" placeholder="Enter your User name" title="Username" className="border-b-2 w-full pl-8 p-3 mb-6"/>
            
            <label htmlFor="uname" className="absolute pt-4 pl-2 block"><BsFillShieldLockFill/></label>
            <input type={passwordVisibility} name="password" id="password" placeholder="Enter your password" title="Password" className="border-b-2 w-full pl-8 p-3"/>
            ...
            <button className="rounded-full border bg-purple-500 text-white font-bold px-5 py-1 mt-5 block">Login</button>
          </form>
        </div>
      </div>
    </div>
