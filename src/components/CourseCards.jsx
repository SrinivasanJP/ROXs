...
function CourseCards({setFragment, title, sDescription, rating, author, id, thumbnail}) {
  const maxRating = 5;
  ...
  return (
    <div className='mt-10 group' onClick={()=>setFragment(["courseView",id])} key={id} >
        ...
        <div className='bg-gradient-to-br from-gray-950 to-green-600 rounded-[.5em] pt-[8em] md:pt-4 md:pl-[20em] p-5 h-[26em] md:h-[16em] mt-4 opacity-90 cursor-pointer group-hover:scale-105 transition-all duration-700 md:group-hover:pl-[22em] md:group-hover:pt-5 group-hover:pt-[9em] shadow-2xl shadow-green-800 text-white overflow-hidden'>
